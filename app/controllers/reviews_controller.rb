class ReviewsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @review.save
        ...
        format.html { redirect_to :back, notice: 'Content cannot be blank!' }
  ...
  def destroy
    @review.destroy
    respond_to do |format|
      format.html { redirect_to "/companies/#{params[:company_id]}", notice: 'Review was successfully destroyed.' }
