class CompaniesController < ApplicationController
  ...
  # GET /companies.json
  def index
    @companies1 = Company.joins("INNER JOIN reviews ON reviews.company_id = companies.id")
    ...
    @companies2 = Company.joins("LEFT JOIN reviews ON companies.id = reviews.company_id WHERE reviews.company_id IS NULL")
